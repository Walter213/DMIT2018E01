...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-offset-1">
        ...
        <asp:RangeValidator ID="RangeEditReleaseyear" runat="server" ErrorMessage="Year needs to be between 1950 and today" Display="None"
            ForeColor="Firebrick" SetFocusOnError="true" ControlToValidate="EditReleaseYear" Type="Integer" MinimumValue="1950"
                ></asp:RangeValidator>
    ...
    <asp:ObjectDataSource ID="AlbumODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Album_FindByArtist" 
        TypeName="ChinookSystem.BLL.AlbumController" OnSelected="CheckForException">
        <SelectParameters>
    ...
    <asp:ObjectDataSource ID="EditArtistListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Artist_List" 
