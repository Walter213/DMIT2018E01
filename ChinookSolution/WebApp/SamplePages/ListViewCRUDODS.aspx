...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <blockquote class="alert alert-info">
        This page will demostrate a CRUD process using the List view
        control and only ODS datasources.
    </blockquote>
    <br /> 
    ...
    <asp:ListView ID="AlbumList" runat="server" DataSourceID="AlbumListODS" 
        ...
        <EditItemTemplate>
            <asp:RequiredFieldValidator ID="RequiredTitleTextBox" runat="server" 
            ...
            <asp:RangeValidator ID="RangeReleaseYearTextBoxE" runat="server"
                ErrorMessage="Year must be between 1950 and today" Display="None" Type="Integer"
                ControlToValidate="ReleaseYearTextBoxE" ValidationGroup="EGroup"
                MinimumValue="1960" MaximumValue='<%# DateTime.Today.Year %>'>
            </asp:RangeValidator>--%>

            <asp:RegularExpressionValidator ID="RequiredReleaseLabelTextBoxE" runat="server"
            ...
            <tr style="background-color: #008A8C; color: #000000;">
                ...
                <td>
                    <asp:DropDownList ID="ArtistList" runat="server" 
                        ...
                        DataTextField="Name"
                        DataValueField="ArtistId"
                        SelectedValue='<%# Bind("ArtistId") %>' Width="300px">
                    </asp:DropDownList>
                </td>
                <td>
                    <asp:TextBox Text='<%# Bind("ReleaseYear") %>' runat="server" ID="ReleaseYearTextBoxE" 
                        width="50px"/></td>
                <td>
        ...
        <InsertItemTemplate>
            <asp:RequiredFieldValidator ID="RequiredTitleTextBoxI" runat="server" 
                ErrorMessage="Title is required" Display="None"
                ControlToValidate="TitleTextBoxI" ValidateGroup="IGroup">
            </asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="RegExTitleTextBox" runat="server"
                ErrorMessage="Title is limited to 160 characters" Display="None"
            ...
            <asp:RegularExpressionValidator ID="RequiredReleaseLabelTextBoxI" runat="server"
                ErrorMessage="Label is limited to 50 characters" Display="None"
            ...
            <tr style="">
                ...
                <td>
                    <asp:TextBox Text='<%# Bind("ReleaseYear") %>' runat="server" ID="ReleaseYearTextBoxI" 
                        width="50px"/></td>
                <td>
    ...
    <asp:ObjectDataSource ID="AlbumListODS" runat="server" 
        DataObjectTypeName="ChinookSystem.Data.Entites.Album" 
    ...
    <asp:ObjectDataSource ID="ArtistListODS" runat="server" 
        ...
        OnSelected="CheckForException">         <%--  Required for all ODS's --%>
    </asp:ObjectDataSource>
</asp:Content>